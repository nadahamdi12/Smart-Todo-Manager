...
public class LoginView extends JFrame {
    ...
    public LoginView() {
        ...
        // Title
        JLabel title = new JLabel("Bon retour");
        title.setFont(new Font("Segoe UI", Font.BOLD, 18));
        title.setForeground(TEXT_MAIN);
        title.setAlignmentX(Component.LEFT_ALIGNMENT);

        JLabel sub = new JLabel("Connectez-vous à votre compte");
        ...
        // Login button
        loginButton = buildPrimaryButton("Se connecter");
        ...
        // Register button
        registerButton = buildOutlineButton("Créer un compte");
